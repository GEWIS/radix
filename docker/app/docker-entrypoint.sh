...
if [ "$1" = 'frankenphp' ] || [ "$1" = 'php' ] || [ "$1" = 'bin/console' ]; then
	...
	# the file is then always present, at worst as old as the image. The weekly app:user:update-ip-databases run
	# replaces the volume copy with a fresh one.
	for database in ip-to-asn.mmdb ip-to-country.mmdb; do
