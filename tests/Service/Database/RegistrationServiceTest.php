...
class RegistrationServiceTest extends TestCase
{
    ...
    {
        return [
            'August, from anywhere' => [
                '2026-08-20',
                '203.0.113.10',
                true,
            ],
            'August, without an address' => [
                '2026-08-20',
                null,
                true,
            ],
            'June, the day before it closes' => [
                '2026-06-30',
                '203.0.113.10',
                true,
            ],
            'July, from the internet' => [
                '2026-07-15',
                '203.0.113.10',
                false,
            ],
            'July, from the department' => [
                '2026-07-15',
                '131.155.68.1',
                true,
            ],
            'July, from the far end of the department' => [
                '2026-07-15',
                '131.155.71.254',
                true,
            ],
