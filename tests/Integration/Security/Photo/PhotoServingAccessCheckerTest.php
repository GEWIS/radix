...
/**
 * The serving gate for the private photos namespace. A full member is granted based on the (already validated)
 * signature without any per-photo query, while a graduate's request runs the per-photo voter so a leaked URL can never
 * bypass their membership cutoff.
 */
