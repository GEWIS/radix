...
class ApiTokenAuthenticatorTest extends TestCase
{
    ...
    public function testResolvesAKnownTokenToItsPrincipal(): void
    {
        ...
        self::assertInstanceOf(
            ApiPrincipalUser::class,
            $user,
        );
        self::assertSame(
            $principal,
            $user->getApiPrincipal(),
        );
    }
    ...
    public function testChallengesWithoutSayingAnything(): void
    {
        ...
        self::assertSame(
            ApiTokenAuthenticator::CHALLENGE,
    ...
    {
        $request = Request::create('https://gewis.nl/api/health');
