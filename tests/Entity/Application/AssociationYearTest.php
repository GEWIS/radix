...
class AssociationYearTest extends TestCase
{
     ...
     * year is named after the calendar year it starts in.
     */
    ...
    public static function momentsAndTheYearTheyBelongTo(): array
    {
        return [
            ...
            'last moment before the rollover' => [
                '2026-06-30 23:59:59',
                2025,
            ],
            'the rollover itself' => [
    ...
    public function testCanBeNamedDirectly(): void
    {
        self::assertSame(
            2026,
            AssociationYear::fromYear(2026)->getYear(),
        );
        self::assertSame(
            '2026-2027',
            AssociationYear::fromYear(2026)->getYearString(),
        );
    }
    ...
    public function testRunsFromJulyFirstToTheLastMomentOfJuneThirtieth(): void
    {
        ...
        self::assertSame(
            ...
            $year->getStartDate()->format('Y-m-d H:i:s.u'),
        );
        self::assertSame(
            '2027-06-30 23:59:59.999999',
            $year->getEndDate()->format('Y-m-d H:i:s.u'),
        );
    }
    ...
    public function testEndsOnTheDayTheNextYearBegins(): void
    {
        ...
        self::assertEquals(
            AssociationYear::fromYear(2027)->getStartDate(),
            $year->endsOn(),
        );
