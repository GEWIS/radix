 ...
 *
 * Tab indents by `indentValue` spaces and Shift+Tab takes that indentation away again. That does take Tab away from
...
export default class extends Controller<HTMLElement> {
    ...
    /**
     * Typed on its own line, so the entity list is a way to start a query rather than a list to copy from.
     */
    ...
    /**
     * Leaves the rewritten lines selected, so the same key can be held to indent further.
     */
