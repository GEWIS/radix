 ...
 */
class MailingListFixture extends Fixture implements FixtureGroupInterface
{
     ...
     * themselves on it afterwards, and which server it is on: the Listmonk id the seed gives it, or null where
     * Mailman has it instead.
     */
    ...
    public function load(ObjectManager $manager): void
    {
        foreach (self::LISTS as $definition) {
            ...
            $list->selfService = $definition['self_service'];
