...
class MemberRepository extends ServiceEntityRepository
{
     ...
     *
     * A member named by a sub-decision can only be stripped of their data, never removed: the decision stands and it
     * stands about them. Every sub-decision that names one is listed here, because the projection of the register
     * refuses the removal outright for the same reason and would do so with an integrity-constraint violation halfway
     * through the deletion rather than with a fallback to {@see \App\Service\Database\Member::clear()}.
     */
