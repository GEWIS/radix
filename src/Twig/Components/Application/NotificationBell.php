 ...
 *
 * The register has no notification records: nothing is addressed to a person and nothing is marked read. What the
 * bell counts is the state of the register and its integrations right now, which is the same set the dashboard opens
 * with, so there is nothing to dismiss and the count goes down by dealing with the thing rather than by looking at
 * it.
 */
#[AsTwigComponent(
