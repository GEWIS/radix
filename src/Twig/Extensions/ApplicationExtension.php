...
final class ApplicationExtension extends AbstractExtension
{
    ...
    /**
     * Member-submitted changes waiting to be approved or rejected.
     *
     * Read off the same figures as the badge above, for the same reason.
     */
    public function memberUpdatesPending(): int
    {
        return $this->frontPageService->getFrontpageData()['updates'];
    }
}
