...
final class ApplicationExtension extends AbstractExtension
{
     ...
     *
     * Counted on its own rather than read from {@see \App\Service\Application\RegisterStatusService}: these two
     * badges are on the administration's sidebar, which every administration page renders, and that service returns
     * the whole state of the register. Reading one number out of it made every page in the administration run the dozen
