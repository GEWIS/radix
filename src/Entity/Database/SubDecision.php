...
abstract class SubDecision
{
     ...
     *
     * The placeholders an implementation puts in the template are what {@see SubDecision::getTranslatedContent()}
     * fills in, so the two have to be changed together.
     */
     ...
     *
     * Used in the implementations of {@see SubDecision::getTranslatedContent()}.
     *
