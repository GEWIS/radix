 ...
 *
 * This is directly related to the contents of decisions in the ledger. Be careful when making changes here and not
 * there.
 *
 ...
 */
enum Languages: string implements TranslatableInterface
{
