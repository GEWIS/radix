 ...
 *
 * The projection does not know about Mailman or Listmonk and does not need to know.
 *
...
class MailingList
{
     ...
     *
     * The length is spelled out because Doctrine only copies an explicit length onto the join columns that reference
     * this one, which would otherwise become unbounded.
     */
    #[Id]
    #[Column(
        type: Types::STRING,
