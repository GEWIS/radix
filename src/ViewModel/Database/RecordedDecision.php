...
/**
 * A decision that has just been recorded, as it is shown back to the person who entered it.
 *
...
final readonly class RecordedDecision
{
     ...
     * @param string[] $warnings what is worth pointing out about the decision, but did not prevent it being recorded
     */
