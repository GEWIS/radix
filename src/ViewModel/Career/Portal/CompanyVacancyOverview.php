 ...
 * what it has not finished, and what has run its course. A vacancy is in one tab only, the one that shows what has to
...
final readonly class CompanyVacancyOverview
{
     ...
     * @param array<string, int>           $counts    how many vacancies are in every tab
     ...
     * @param string        $filter    the requested tab, which falls back to all for anything unknown
     */
