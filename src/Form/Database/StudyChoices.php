...
class StudyChoices
{
    ...
    {
        return [
            new TranslatableMessage('Bachelor Programs'),
            new TranslatableMessage('Pre-master Programs'),
            new TranslatableMessage('Master Programs'),
            new TranslatableMessage('EngD / PhD Programs'),
            new TranslatableMessage('Other'),
            new TranslatableMessage('Special cases (secretary use only)'),
        ];
    }
