 ...
 *
 * Deliberately not {@see GenerateImageVariantMessage}: the serving path raises that one on a miss, and the two require
 * opposite behaviour for an original narrower than the target. A miss must still produce something to serve, a
 * backfill must not store an upscale. Keeping them apart also means neither has to add a field, which the default
