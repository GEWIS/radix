 ...
 * synchronously so the admin interface can show it right away; only the mail is queued. The plaintext token is passed
 * on the bus because only its hash is stored and the link cannot otherwise be rebuilt.
 */
