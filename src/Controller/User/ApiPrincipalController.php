...
#[Route(path: '/users/api-principals')]
final class ApiPrincipalController extends AbstractController
{
    ...
    {
        return $this->render(
            'database/user/api-principal/index.html.twig',
            [
    ...
    public function create(Request $request): Response
    {
        ...
        return $this->render(
            'database/user/api-principal/create.html.twig',
            ['form' => $form],
        );
    }
    ...
    public function edit(
        ...
        return $this->render(
            'database/user/api-principal/edit.html.twig',
            ['form' => $form],
        );
    }
