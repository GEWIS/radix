...
abstract class AbstractSecurityController extends AbstractController
{
    ...
    public function passwordResetClaim(
        ...
        $tempHash = $this->passwordResetService->claim($passwordReset);
    ...
    public function passwordResetForm(
        ...
        if ($request->isMethod('GET')) {
            ...
            if (null !== $tempHash) {
                ...
                // Single-use: spent before the reset is bound to the session.
                $this->passwordResetService->consumeTempHash($passwordReset);
    ...
    public function security(
        ...
        if (
            ...
            if (
                ...
                $this->accountPasswordService->change(
                    $user,
    ...
    public function mfaEnable(
        ...
        if (
            ...
            if (
                ...
                // Every session is made to sign in again, so none stays behind on single-factor.
                $this->multiFactorService->enable(
                    $user,
                    $secret,
                );
    ...
    public function mfaRegenerateBackupCodes(
        ...
        $this->multiFactorService->forceRelogin($user);
