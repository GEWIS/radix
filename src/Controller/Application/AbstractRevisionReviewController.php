...
abstract class AbstractRevisionReviewController extends AbstractRevisionController
{
    ...
    protected function applyDecision(
        ...
        if (
            !$this->revisionReviewService->canApply(
                $revision,
                $transition,
            )
        ) {
        ...
        $this->revisionReviewService->applyTransition(
            $revision,
            $actor,
            $transition,
            $this->decisionMessage($form),
        );
    ...
    protected function discardDraft(
        ...
        $this->revisionReviewService->discard($revision);
    ...
    protected function handleCommentPost(
        ...
        $this->revisionReviewService->comment(
            $revision,
            $actor,
            $message,
        );
