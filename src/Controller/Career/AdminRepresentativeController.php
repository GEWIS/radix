...
class AdminRepresentativeController extends AbstractController
{
    public function __construct(
        ...
        private readonly CompanyRepresentativeService $representativeService,
    ...
    public function disableRepresentative(
        ...
        $this->representativeService->disable(
            $company,
            $representative,
            $user,
        );
    ...
    public function enableRepresentative(
        ...
        $this->representativeService->enable(
            $company,
            $representative,
            $user,
        );
    ...
    public function removeRepresentative(
        ...
        $this->representativeService->remove(
            $company,
            $representative,
            $user,
        );
    ...
    public function makePrimaryContact(
        ...
        $this->representativeService->makePrimaryContact(
            $company,
            $representative,
            $user,
        );
