...
class AdminOptionPeriodController extends AbstractController
{
    public function __construct(
        ...
        private readonly OptionPeriodService $optionPeriodService,
    ...
    public function create(Request $request): Response
    {
        ...
        $this->optionPeriodService->save($period);
    ...
    public function delete(OptionPeriod $period): Response
    {
        ...
        $this->optionPeriodService->delete($period);
    ...
    public function limits(
        ...
        if (
            ...
            $this->optionPeriodService->saveLimit($limit);
    ...
    public function deleteLimit(
        ...
        $this->optionPeriodService->deleteLimit($limit);
