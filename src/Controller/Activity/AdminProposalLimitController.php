...
use App\Service\Activity\ProposalLimitService;
...
class AdminProposalLimitController extends AbstractController
{
    public function __construct(
        ...
        private readonly ProposalLimitService $proposalLimitService,
    ...
    public function index(Request $request): Response
    {
        ...
        if (
            ...
            $this->proposalLimitService->save($limit);
    ...
    {
        $this->proposalLimitService->delete($limit);
