...
final class MemberController extends AbstractMemberController
{
    ...
    {
        return $this->render(
            'database/member/attention-needed.html.twig',
    ...
    public function bulkRenewal(Request $request): Response
    {
        ...
        return $this->render(
            'database/member/bulk-renewal.html.twig',
            [
                'form' => $form,
    ...
    public function show(
        ...
        return $this->render(
            'database/member/show.html.twig',
            [
    ...
    public function edit(
        ...
        return $this->render(
            'database/member/edit.html.twig',
            [
                'form' => $form,
                'member' => $member,
            ],
    ...
    public function delete(
        ...
        return $this->render(
            'database/member/delete.html.twig',
            [
                'form' => $form,
                'member' => $member,
    ...
    public function lists(
        ...
        if ($this->memberService->isMailingListSyncLocked()) {
            return $this->render(
                'database/member/mailinglist-sync-status.html.twig',
                ['member' => $member],
            );
        }
        ...
        return $this->render(
            'database/member/lists.html.twig',
            [
                'form' => $form,
                'member' => $member,
            ],
