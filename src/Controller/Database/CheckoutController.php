...
final class CheckoutController extends AbstractController
{
    ...
    public function restartResume(Request $request): Response
    {
        ...
        // Cleared before the checkout reopens, so the same hash cannot be used twice.
    ...
    private function renderStatus(
        ...
        // Only a hash is stored, so a new token is generated here and the previous link is invalidated.
