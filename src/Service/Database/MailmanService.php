...
class MailmanService
{
     ...
     * Acquire sync lock.
     *
     * To ensure that the sync between the register and Mailman is as clean as possible, we need to acquire a global
     ...
     * Release sync lock.
     *
     * Releases the sync lock after the sync between the register and Mailman happened.
     */
    ...
    /**
     * Fetch mailing lists from mailman and import them to the mailmanlist model in the register
     */
