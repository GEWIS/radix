...
class ListmonkService
{
     ...
     * Acquire sync lock.
     *
     * To ensure that the sync between the register and Listmonk is as clean as possible, we need to acquire a global
     * lock on the mail list administration. This will prevent (if properly implemented and used) concurrent syncs
     * from running.
     */
     ...
     * Release sync lock.
     *
     * Releases the sync lock after the sync between the register and Listmonk happened.
     */
    ...
    /**
     * Fetch mailing lists from listmonk and import them to the listmonklist model in the register
     */
