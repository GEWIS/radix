...
final class ProjectionState
{
     ...
     *
     * Generating into the projection flushes it, and that flush reaches the update listener again through the
     * entities it just wrote; this is what stops the recursion.
     */
