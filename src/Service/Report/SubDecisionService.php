...
class SubDecisionService
{
    ...
    /**
     * Generates related entities of a subdecision into the projection.
     */
    ...
    /**
     * Reverts the related entities of a subdecision in the projection, i.e. undoes {@see self::generateRelated()}.
     *
     ...
     *
     * Whether reverting is allowed at all is decided in the `Database` domain, which owns the ledger; by the time a
