...
final readonly class ActivityProposalManager
{
    ...
    /**
     * Save an edit to a proposal that has not been decided on yet.
     */
    public function save(ActivityProposal $proposal): void
    {
    ...
    /**
     * Whether this proposal's reserved day can still be settled.
     */
    public function canClearBudget(ActivityProposal $proposal): bool
    {
        return $this->activityProposalStateMachine->can(
            $proposal,
            'clear_budget',
        );
    }
    ...
    public function revokeClearance(ActivityProposal $proposal): void
    {
        $this->activityProposalStateMachine->apply(
            $proposal,
            'revoke_clearance',
