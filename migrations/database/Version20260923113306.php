 ...
 */
final class Version20260923113306 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Drop the table of changes a member proposed for the secretary to approve. Nothing ever wrote to it,'
            . ' and now that the website and the register are one application it is no longer needed.';
    }
