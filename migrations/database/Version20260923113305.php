 ...
 */
final class Version20260923113305 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Store only half of an action link\'s token, and the hash of the other half, so a link that was sent'
            . ' cannot be read back out of the register. Every outstanding link is given a new token that was never'
            . ' sent, so every renewal and payment link already in a mailbox stops working.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        // Random on both halves rather than derived from the token being dropped: a selector that can be computed
        // from what was mailed is still half of a credential.
    ...
    public function down(Schema $schema): void
    {
        ...
        // Migrating down leaves the links unusable as well, for the same reason.
