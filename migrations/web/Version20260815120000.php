    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE ActivityProposal
              ...
              ADD CONSTRAINT FK_25B61AC43174800F FOREIGN KEY (createdBy_id) REFERENCES Member (lidnr) ON DELETE SET NULL,
              ...
              ADD CONSTRAINT FK_25B61AC485C5BBC FOREIGN KEY (decidedBy_id) REFERENCES Member (lidnr) ON DELETE SET NULL,
              ADD CONSTRAINT FK_25B61AC43B1D491C FOREIGN KEY (budgetClearedBy_id) REFERENCES Member (lidnr) ON DELETE SET NULL
            SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ActivityDateOption
              ADD CONSTRAINT FK_D57D3CDCF4792058 FOREIGN KEY (proposal_id) REFERENCES ActivityProposal (id),
              ADD CONSTRAINT FK_D57D3CDC85C5BBC FOREIGN KEY (decidedBy_id) REFERENCES Member (lidnr) ON DELETE SET NULL
            SQL);
