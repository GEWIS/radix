    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE OrganInformationRevision
              ...
              ADD CONSTRAINT FK_61242DD5F675F31B FOREIGN KEY (author_id) REFERENCES Member (lidnr) ON DELETE SET NULL,
              ADD CONSTRAINT FK_61242DD5FD16CEE4 FOREIGN KEY (authorCompanyUser_id) REFERENCES CompanyUser (id) ON DELETE SET NULL,
              ADD CONSTRAINT FK_61242DD570574616 FOREIGN KEY (reviewer_id) REFERENCES Member (lidnr) ON DELETE SET NULL,
              ADD CONSTRAINT FK_61242DD5A19E445F FOREIGN KEY (lastEditedBy_id) REFERENCES User (lidnr) ON DELETE SET NULL,
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE OrganInformationRevisionComment
              ...
              ADD CONSTRAINT FK_AEDB4858F675F31B FOREIGN KEY (author_id) REFERENCES User (lidnr) ON DELETE SET NULL,
