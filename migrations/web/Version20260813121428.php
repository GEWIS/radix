    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE PollRevision
              ...
              ADD CONSTRAINT FK_439C020F675F31B FOREIGN KEY (author_id) REFERENCES Member (lidnr) ON DELETE SET NULL,
              ADD CONSTRAINT FK_439C020FD16CEE4 FOREIGN KEY (authorCompanyUser_id) REFERENCES CompanyUser (id) ON DELETE SET NULL,
              ADD CONSTRAINT FK_439C02070574616 FOREIGN KEY (reviewer_id) REFERENCES Member (lidnr) ON DELETE SET NULL,
              ADD CONSTRAINT FK_439C020A19E445F FOREIGN KEY (lastEditedBy_id) REFERENCES User (lidnr) ON DELETE SET NULL,
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE PollRevisionComment
              ...
              ADD CONSTRAINT FK_A6CF0178F675F31B FOREIGN KEY (author_id) REFERENCES User (lidnr) ON DELETE SET NULL,
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE PollCommentReaction
              ...
              ADD CONSTRAINT FK_68E4C8D0B44475EE FOREIGN KEY (member_lidnr) REFERENCES Member (lidnr) ON DELETE SET NULL
            SQL);
